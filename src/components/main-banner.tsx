export function MainBanner() {
  return (
    <section
      className="h-[533px] lg:h-[671px] bg-cover bg-center"
      style={{ backgroundImage: "url('/assets/main-banner.png')" }}
    >
      <div className="text-white h-full font-bold font-poppins text-[60px] px-10 flex items-center justify-center md:justify-start">
        <div>
