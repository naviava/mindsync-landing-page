    ...
    >
      ...
      <div className="max-w-7xl mx-auto bg-white rounded-3xl py-10 px-4 shadow-[0_10px_4px_10px_rgba(0,0,0,0.25)]">
        ...
        <div className="flex flex-col xl:flex-row items-center mt-4 md:mt-6 lg:px-10 gap-10">
          ...
          {/* Grid */}
          <ul className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-1 gap-8 xl:gap-4">
      ...
      {/* Mission Vision. */}
      <ul className="relative my-24 flex flex-col lg:flex-row justify-center max-w-md mx-auto gap-y-8 gap-x-14 lg:max-w-[1000px]">
...
function MVCard(props: {
  ...
  return (
    <li className="relative bg-[#00327D] px-8 py-6 rounded-2xl text-white">
